...
(function () {
  ...
  const translations = {
    es: {
      ...
      'process.philosophy.title': 'Filosofia',
      'process.philosophy.body': 'Creo en el desarrollo de soluciones que conectan personas y procesos de manera eficiente. El desacoplamiento y la arquitectura limpia son fundamentales para crear sistemas escalables.',
      'process.focus.title': 'Enfoque Tecnico',
      'process.focus.item1': 'Desacoplamiento Frontend-Backend',
      'process.focus.item2': 'APIs REST bien definidas',
      'process.focus.item3': 'Validacion de datos robusta',
      'process.focus.item4': 'Interfaces centradas en el usuario',
    ...
    en: {
      ...
      'process.philosophy.title': 'Philosophy',
      'process.philosophy.body': 'I believe in building solutions that connect people and processes efficiently. Decoupling and clean architecture are essential for scalable systems.',
      'process.focus.title': 'Technical Focus',
      'process.focus.item1': 'Frontend-Backend decoupling',
      'process.focus.item2': 'Well-defined REST APIs',
      'process.focus.item3': 'Robust data validation',
      'process.focus.item4': 'User-centered interfaces',
